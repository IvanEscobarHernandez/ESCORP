                ...
                <div class="contenedor_check_slider_main_contacto">
                    ...
                    <div class="checklist_contacto_main">
                        ...
                        <div class="contacto_main">
                            ...
                            <p class="copy_contacto_main" >En esta sección puedes encontrar la manera de ponerte en contácto con nosotros para agendar tu viaje.</p>
                        </div>
        
                        <div class="contacto_main">
                            <p class="copy_contacto_main" >Por ahora la mejor opción para cotizar y agendar tus viajes es por whatsApp.</p>
                        </div>

                        <div class="contacto_main">
                            <p class="copy_contacto_main"> <span class="glyphicon glyphicon-phone"></span> 55 3444 2116.</p>
                        </div>
                    ...
                    <div class="formulario_container_contacto">
                        <img src="../img/contacto2.jpg" class="contacto_img">
