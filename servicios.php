...
<head>
    ...
    <link rel="stylesheet" href="css/ESCORP/serviciosESCORP.css">
...
<body>
    ...
    <div class="container_nosotros">
        ...
        <header>
            <br><br><br>
            <img src="img/ESCORP/headerESCORP5.jpg" class="img_head" alt="Image not available">

            <!-- Titulo y Sub -->
            <div class="container_header">

                <div class="container_header_title">
                    <h1 class="title_header">Conoce nuestros servicios...</h1>
                </div>
        ...
        <section class="events" id="events">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="imagen">
                        <img src="img/ESCORP/sliderInicio1.jpg" alt="Image not available">
                        <div class="capa">
