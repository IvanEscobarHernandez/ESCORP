            ...
            <div class="card-wrapper">
                ...
                <div class="card_left">
                    ...
                    <div class="swiper mySwiper2">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="../img/Clean/multi_1.1.1.png" class="gallery-item" alt="Image not available">
                            </div>
                            <div class="swiper-slide">
                                <img src="../img/Clean/multi_2.1.1.png" class="gallery-item" alt="Image not available">
                            </div>
                            <div class="swiper-slide">
                                <img src="../img/Clean/multi_3.1.1.png" class="gallery-item" alt="Image not available">
                            </div>
                            <div class="swiper-slide">
                                <img src="../img/Clean/multi_5.1.1.png" class="gallery-item" alt="Image not available">
                            </div>
                            <div class="swiper-slide">
                                <img src="../img/Clean/multi_4.1.1.png" class="gallery-item" alt="Image not available">
                            </div>
                        </div>
                    </div>
                    <div thumbsSlider="" class="swiper mySwiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="../img/Clean/multi_1.1.1.png" alt="Image not available">
                            </div>
                            <div class="swiper-slide">
                                <img src="../img/Clean/multi_2.1.1.png" alt="Image not available">
                            </div>
                            <div class="swiper-slide">
                                <img src="../img/Clean/multi_3.1.1.png" alt="Image not available">
                            </div>
                            <div class="swiper-slide">
                                <img src="../img/Clean/multi_5.1.1.png" alt="Image not available">
                            </div>
                            <div class="swiper-slide">
                                <img src="../img/Clean/multi_4.1.1.png" alt="Image not available">
                            </div>
                        </div>
                ...
                <div class="product-content">
                    ...
                    <h2 class="product-tittle">Fabuscorp</h2>
                    <div class="line"></div>
                    ...
                    <div class="product-detail">
                        <h2>Descripción:</h2>
                        <div class="line"></div>
                        <p>Es un excelente limpiador de grado institucional para limpieza de toda superficie, lavable con agua.</p>
                        <p>Elimina suciedad, grasa ligera y cochambre de pisos, muebles, superficies de plástico o vinilo, paredes pintadas, puertas, etc.</p>
                        ...
                        <ul>
                            <li><i id="check" class="fas fa-check-circle"></i> Aromas: <span>Lavanda, Cítricos, Menta Explosiva, Lima-limón, Manzana-canela, Violetas.</span></li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="../img/Clean/multi_1.1.1.png" alt=" product image" class="modal-img">
                </div>
