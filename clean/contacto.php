...
<head>
    ...
    <link rel="stylesheet" href="../css/Clean/contactoCLEAN.css">
...
<body>
    <div class="container_contacto">
        ...
        <header class="header_contacto">
            ...
            <img src="../img/Clean/contacto2.jpg" class="img_head_contacto" alt="Image not available">
                ...
                <div class="contenedor_check_slider_main_contacto">
                    ...
                    <div class="checklist_contacto_main">
                        ...
                        <div class="contacto_main">
                            ...
                            <p class="copy_contacto_main">Si eres un prestador de servicios que se identifica con nuestros valores, o requieres cotizar alguno de nuestros productos contáctanos.
                                <br><br>
                                En esta sección encontrarás la manera de ponerte en contacto con ESCORP Clean, con gusto te asesoramos y atendemos.
                                <br><br>
                                Por ahora la mejor opción es llenando el siguiente formulario, enviando un mensaje via WhatsApp a los siguientes números:
                                <br><br>
                                <span class="glyphicon glyphicon-phone"></span> 55 3444 2116.
                                <br>
                                <span class="glyphicon glyphicon-phone"></span> 55 4569 1270.
                                <br><br>
                    ...
                    <div class="formulario_container_contacto">
                        <img src="../img/Clean/formulario.webp" class="contacto_img" alt="Image not available">
