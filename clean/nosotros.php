    ...
    <div class="container_nosotros">
        ...
        <header>
            ...
            <div class="container_header">  
                ...
                <div class="sub_header_left1"><p class="copy_header">Calidad.</p></div>
        
                <div class="sub_header_left2"><p class="copy_header">Precio.</p></div>
        
                <div class="sub_header_left3"><p class="copy_header">Servicio.</p></div>
        ...
        <main>
            <section class="section_nosotros_main">
                ...
                <div>
                    <b><h1 class="titulos_events">Acerca de Clean</h1></b>
                    <div class="line"></div>
                </div>
