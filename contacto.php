...
<head>
    ...
    <link rel="stylesheet" href="css/contactoESCORP.css">
...
<div class="container_contacto">
        ...
        <header class="header_contacto">
            ...
            <img src="img/contacto1.jpg" class="img_head_contacto">
        ...
        <main>
            <section class="section_contacto_main">
                ...
                <div class="contenedor_subtitulo_main_contacto"> <h2 class="subtitulo_main_contacto">Contáctanos</h2></div>
                <div class="line"></div>
                ...
                <div class="contenedor_check_slider_main_contacto">
                    ...
                    <div class="checklist_contacto_main">
                        ...
                        <div class="contacto_main">
                            <br><h3 class="n_contacto_main">Estamos para servirte</h3>
                            <div class="line_main"></div>
                            <p class="copy_contacto_main" >Si eres un prestador de servicios que se identifica con nuestros valores, contáctanos.</p>
                        </div>

                        <div class="contacto_main">
                            <p class="copy_contacto_main">En esta sección encontrarás la manera de ponerte en contácto con ESCORP para exponer como funciona tu negocio.</p>
                        </div>
        
                        <div class="contacto_main">
                            <p class="copy_contacto_main" >Por ahora la mejor opción para contactarnos es llenando el siguiente formulario o enviando un correo a la siguiente dirección:</p>
                        </div>

                        <div class="contacto_main">
                            <br><p style="text-align:center;" class="copy_contacto_main"> <i class="fa-solid fa-envelope-open-text"></i> contacto@escorp.com.mx</p>
                        </div>

                        <div class="contacto_main">
                            <br><h3 class="n_contacto_main">Horario de Contacto</h3>
                            <div class="line_main"></div>
                            <p class="copy_contacto_main" >Todos los días:  8:00 - 22:00.</p>
                        </div>

                        <div class="contacto_main">
                            <br><h3 class="n_contacto_main">Horario de servicio</h3>
                            <div class="line_main"></div>
                    ...
                    <div class="formulario_container_contacto">
                        <img src="img/joinUsESCORP4.jpg" class="contacto_img">
